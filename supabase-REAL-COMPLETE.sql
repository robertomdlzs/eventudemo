...
-- Insertar eventos
INSERT INTO ticket_types (event_id, name, description, price, quantity, sold, status), price, status, featured, main_image_url) VALUES
