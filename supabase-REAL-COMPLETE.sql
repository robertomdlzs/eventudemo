...
CREATE TABLE public.backup_schedules (
    ...
    CONSTRAINT backup_schedules_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'inactive'::character varying])::text[])))
);
...
CREATE TABLE public.categories (
    ...
    CONSTRAINT categories_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'inactive'::character varying])::text[])))
);
...
CREATE TABLE public.sales_points (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT sales_points_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'inactive'::character varying])::text[])))
);
...
CREATE TABLE public.scheduled_reports (
    ...
    CONSTRAINT scheduled_reports_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'inactive'::character varying])::text[])))
);
...
CREATE TABLE public.ticket_types (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT ticket_types_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'inactive'::character varying, 'sold_out'::character varying])::text[])))
);
...
CREATE TABLE public.users (
    ...
    CONSTRAINT users_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'inactive'::character varying, 'suspended'::character varying])::text[])))
);
...
CREATE TABLE public.virtual_tickets (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT virtual_tickets_status_check CHECK (((status)::text = ANY ((ARRAY['published'::character varying, 'used'::character varying, 'cancelled'::character varying, 'expired'::character varying])::text[])))
);
...
('Música', 'musica', 'Conciertos y eventos musicales', 'published'),
('Gastronomía', 'gastronomia', 'Festivales de comida y eventos culinarios', 'published'),
('Tecnología', 'tecnologia', 'Conferencias y eventos tecnológicos', 'published'),
('Deportes', 'deportes', 'Eventos deportivos y competencias', 'published'),
('Arte y Cultura', 'arte-cultura', 'Exposiciones y eventos culturales', 'published')
;

-- Insertar usuarios
INSERT INTO users (email, password_hash, first_name, last_name, role, status) VALUES
('admin@eventu.co', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin', 'Principal', 'admin', 'published'),
('organizer@eventu.co', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Organizador', 'Eventos', 'organizer', 'published'),
('user@eventu.co', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Usuario', 'Demo', 'user', 'published')
;
...
(1, 'Concierto de Rock Nacional', 'concierto-rock-nacional-2024', 'Un increíble concierto de rock con las mejores bandas del país', '2024-12-25', '20:00', 'Estadio El Campín', 'Bogotá, Colombia', 1, 2, 50000, 150000, 'published', true, '/images/rock-concert.jpg'),
(2, 'Festival de Comida Internacional', 'festival-comida-internacional-2024', 'Disfruta de la mejor gastronomía local e internacional', '2024-12-30', '12:00', 'Parque Simón Bolívar', 'Bogotá, Colombia', 2, 2, 10000, 50000, 'published', true, '/images/food-festival.jpg'),
(3, 'Conferencia de Tecnología 2025', 'conferencia-tecnologia-2025', 'Las últimas tendencias en tecnología y desarrollo', '2025-01-15', '09:00', 'Centro de Convenciones', 'Medellín, Colombia', 3, 2, 2000, 200000, 'published', false, '/images/tech-conference.jpg')
;
INSERT INTO ticket_types (event_id, name, description, price, quantity, sold, status) VALUES
(1, 'General', 'Acceso general al concierto', 150000, 40000, 20000, 'published'),
(1, 'VIP', 'Acceso VIP con beneficios especiales', 300000, 10000, 5000, 'published'),
(2, 'Entrada General', 'Acceso a todas las zonas del festival', 50000, 8000, 4000, 'published'),
(2, 'Premium', 'Acceso premium con degustaciones', 100000, 2000, 1000, 'published'),
(3, 'Estudiante', 'Descuento para estudiantes', 150000, 1000, 400, 'published'),
(3, 'Profesional', 'Entrada para profesionales', 200000, 1000, 400, 'published')
;
...
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('1', 'Conciertos', 'conciertos', 'Eventos musicales y conciertos en vivo', 'Music', '#FF6B6B', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('2', 'Teatro', 'teatro', 'Obras de teatro y espectáculos dramáticos', 'Drama', '#4ECDC4', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('3', 'Deportes', 'deportes', 'Eventos deportivos y competencias', 'Trophy', '#45B7D1', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('4', 'Conferencias', 'conferencias', 'Conferencias, seminarios y eventos corporativos', 'Users', '#96CEB4', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('5', 'Festivales', 'festivales', 'Festivales culturales y gastronómicos', 'Star', '#FFEAA7', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('6', 'Familiar', 'familiar', 'Eventos para toda la familia', 'Heart', '#DDA0DD', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
INSERT INTO categories (id, name, slug, description, icon, color, status, created_at, updated_at) VALUES ('7', 'Educación', 'educacion', 'Talleres, cursos y eventos educativos', 'BookOpen', '#98D8C8', 'published', '2025-08-19 16:06:26.149857', '2025-08-19 16:06:26.149857');
...
INSERT INTO sales_points (id, name, location, address, contact_person, contact_phone, contact_email, status, created_at, updated_at) VALUES ('1', 'Punto de Venta Centro', 'Centro Comercial Plaza Central', 'Calle 123 #45-67, Centro', 'María González', '3001234567', 'centro@eventu.co', 'published', '2025-08-26 12:39:22.110964', '2025-08-26 12:39:22.110964');
INSERT INTO sales_points (id, name, location, address, contact_person, contact_phone, contact_email, status, created_at, updated_at) VALUES ('2', 'Punto de Venta Norte', 'Centro Comercial Norte', 'Avenida Norte #89-12, Norte', 'Carlos Rodríguez', '3002345678', 'norte@eventu.co', 'published', '2025-08-26 12:39:22.110964', '2025-08-26 12:39:22.110964');
INSERT INTO sales_points (id, name, location, address, contact_person, contact_phone, contact_email, status, created_at, updated_at) VALUES ('3', 'Punto de Venta Sur', 'Centro Comercial Sur', 'Carrera 78 #34-56, Sur', 'Ana Martínez', '3003456789', 'sur@eventu.co', 'published', '2025-08-26 12:39:22.110964', '2025-08-26 12:39:22.110964');
...
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('4', '3', 'Entrada General', 'Asiento numerado', '35000.00', '400', '0', '6', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.16093');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('6', '4', 'Entrada Regular', 'Entrada estándar', '120000.00', '200', '0', '4', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.16093');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('8', '5', 'Tribuna Sur', 'Tribuna Sur del estadio', '25000.00', '500', '0', '10', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.16093');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('9', '5', 'Palco VIP', 'Palco VIP con servicios premium', '80000.00', '200', '0', '4', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.16093');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('1', '1', 'Platea', 'Asientos en platea principal', '50000.00', '600', '2', '6', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.167084');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('2', '1', 'Palcos', 'Asientos en palcos VIP', '75000.00', '200', '1', '4', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.17141');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('3', '2', 'Entrada General', 'Acceso completo al festival', '80000.00', '500', '3', '8', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.171618');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('5', '4', 'Early Bird', 'Precio especial por compra anticipada', '100000.00', '100', '1', '2', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.171795');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('7', '5', 'Tribuna Norte', 'Tribuna Norte del estadio', '25000.00', '500', '4', '10', NULL, NULL, 'published', '2025-08-19 16:06:26.16093', '2025-08-19 16:06:26.172023');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('10', '6', 'General', 'Acceso general al concierto', '45000.00', '1500', '0', '8', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('11', '6', 'VIP', 'Zona VIP con bar incluido', '85000.00', '300', '0', '4', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('12', '6', 'Palco Premium', 'Palcos con servicio completo', '150000.00', '200', '0', '6', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('14', '7', 'Startup', 'Incluye stand de exhibición', '200000.00', '100', '0', '2', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('15', '7', 'Inversor', 'Acceso VIP y networking exclusivo', '350000.00', '100', '0', '2', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('17', '8', 'Palcos', 'Palcos con vista privilegiada', '120000.00', '300', '0', '4', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('18', '8', 'Premium', 'Experiencia completa con cena', '200000.00', '100', '0', '2', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('20', '9', 'Preferencial', 'Mejores ubicaciones', '65000.00', '50', '0', '4', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('21', '10', 'General', 'Acceso general al torneo', '35000.00', '6000', '0', '10', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('22', '10', 'Premium', 'Zona premium con merchandising', '55000.00', '1500', '0', '6', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('23', '10', 'VIP Gamer', 'Meet & greet con jugadores', '95000.00', '500', '0', '4', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('24', '11', 'Estudiante', 'Precio especial estudiantes', '100000.00', '100', '0', '2', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('26', '11', 'Empresarial', 'Incluye consultoría personalizada', '250000.00', '20', '0', '1', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.116019');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('13', '7', 'Emprendedor', 'Acceso completo al evento', '75000.00', '600', '2', '3', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.120789');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('16', '8', 'Platea', 'Asientos en platea principal', '85000.00', '800', '1', '6', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.125099');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('19', '9', 'General', 'Asientos numerados', '42000.00', '300', '2', '6', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.125452');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('25', '11', 'Profesional', 'Acceso completo y certificado', '150000.00', '80', '4', '3', NULL, NULL, 'published', '2025-08-19 16:07:58.116019', '2025-08-19 16:07:58.125703');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('27', '1', 'General', 'Acceso general al evento', '75000.00', '100', '0', '5', NULL, NULL, 'published', '2025-08-20 12:13:51.879188', '2025-08-20 12:13:51.879188');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('28', '1', 'VIP', 'Acceso VIP con beneficios especiales', '150000.00', '50', '0', '3', NULL, NULL, 'published', '2025-08-20 12:13:51.879188', '2025-08-20 12:13:51.879188');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('29', '2', 'Platea', 'Asiento en platea', '85000.00', '80', '0', '4', NULL, NULL, 'published', '2025-08-20 12:13:51.879188', '2025-08-20 12:13:51.879188');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('30', '2', 'Balcón', 'Asiento en balcón', '65000.00', '120', '0', '6', NULL, NULL, 'published', '2025-08-20 12:13:51.879188', '2025-08-20 12:13:51.879188');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('31', '12', 'General', 'Acceso general al concierto futuro', '100000.00', '100', '0', '5', NULL, NULL, 'published', '2025-08-20 12:19:03.186841', '2025-08-20 12:19:03.186841');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('32', '1', 'VIP', 'Acceso VIP con asientos preferenciales, bebidas incluidas y meet & greet', '250000.00', '200', '0', '4', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('33', '1', 'General', 'Acceso general al festival', '150000.00', '4800', '0', '10', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('34', '2', 'Premium', 'Acceso completo a la conferencia con networking exclusivo', '350000.00', '100', '0', '2', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('35', '2', 'Estándar', 'Acceso a charlas y exhibición', '250000.00', '700', '0', '5', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('36', '3', 'Preferencial', 'Asientos en las mejores ubicaciones del estadio', '120000.00', '5000', '0', '6', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('37', '3', 'General', 'Asientos generales del estadio', '80000.00', '31000', '0', '10', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('38', '4', 'Guía Incluida', 'Entrada con tour guiado por expertos', '65000.00', '100', '0', '4', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('39', '4', 'General', 'Entrada general a la exposición', '45000.00', '200', '0', '6', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('40', '5', 'VIP Executive', 'Acceso VIP con networking exclusivo y cena de gala', '500000.00', '50', '0', '2', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('41', '5', 'Profesional', 'Acceso completo a la cumbre', '350000.00', '450', '0', '3', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('42', '6', 'Gourmet', 'Acceso completo con degustaciones premium', '120000.00', '300', '0', '4', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('43', '6', 'General', 'Acceso general al festival', '75000.00', '1700', '0', '8', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('44', '7', 'Palco', 'Asientos en palco con servicio de bebidas', '180000.00', '100', '0', '4', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('45', '7', 'Platea', 'Asientos en platea del teatro', '120000.00', '700', '0', '6', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('46', '8', 'Elite', 'Kit completo de corredor con beneficios especiales', '50000.00', '500', '0', '2', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
INSERT INTO ticket_types (id, event_id, name, description, price, quantity, sold, max_per_order, sale_start, sale_end, status, created_at, updated_at) VALUES ('47', '8', 'General', 'Inscripción general a la maratón', '35000.00', '9500', '0', '1', NULL, NULL, 'published', '2025-08-20 13:12:24.586558', '2025-08-20 13:12:24.586558');
...
INSERT INTO users (id, first_name, last_name, email, password_hash, role, status, is_2fa_enabled, two_factor_secret, email_verified_at, created_at, updated_at, last_login, phone) VALUES ('27', 'Super', 'Admin', 'superadmin@eventu.co', '$2a$12$rvExGdHWiowcQJNAWSHDO.jg7hMp.5xUcJN4jMAAaMplJcNA3QEce', 'admin', 'published', 'f', NULL, NULL, '2025-08-25 16:17:42.923617', '2025-08-25 16:19:44.93338', NULL, '3001234567');
INSERT INTO users (id, first_name, last_name, email, password_hash, role, status, is_2fa_enabled, two_factor_secret, email_verified_at, created_at, updated_at, last_login, phone) VALUES ('28', 'Admin', 'Test', 'admin@test.com', '$2a$12$dV63JjtvuBTuawMC9lZDde6866CLhPxd.vB672Ky5UQZN4Qu/onLu', 'admin', 'published', 'f', NULL, NULL, '2025-08-26 11:45:43.746682', '2025-08-26 11:45:53.238031', NULL, '123456789');
INSERT INTO users (id, first_name, last_name, email, password_hash, role, status, is_2fa_enabled, two_factor_secret, email_verified_at, created_at, updated_at, last_login, phone) VALUES ('29', 'Test', 'Admin', 'testadmin@eventu.com', '$2a$12$HCg11wRjW.D9E0T966I0t.SVnupiGzMAArJZ.x2WkwzAQBSNQViJS', 'user', 'published', 'f', NULL, NULL, '2025-08-27 16:50:34.127608', '2025-08-27 16:50:34.127608', NULL, NULL);
INSERT INTO users (id, first_name, last_name, email, password_hash, role, status, is_2fa_enabled, two_factor_secret, email_verified_at, created_at, updated_at, last_login, phone) VALUES ('30', 'Admin', 'Analytics', 'analytics@eventu.com', '$2a$12$cwEVVn40mc7KBYhobMMVUuuN3myUB0dJM7LX1Wz.TNu6zaZ9nY4PS', 'user', 'published', 'f', NULL, NULL, '2025-08-28 09:56:24.35354', '2025-08-28 09:56:24.35354', NULL, NULL);
