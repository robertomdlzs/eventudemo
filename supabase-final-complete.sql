...
-- =====================================================
-- EXTRAER ESTRUCTURA COMPLETA DEL ARCHIVO ORIGINAL
-- =====================================================
--
...
-- =====================================================
-- CONVERSIÓN DE DATOS COPY A INSERT PARA SUPABASE
-- =====================================================
...
INSERT INTO audit_logs (id, user_id, user_name, user_email, action, resource, resource_id, details, ip_address, user_agent, "timestamp", severity, status) VALUES
(1, 'admin1', 'Admin Principal', 'admin@eventu.co', 'LOGIN', 'auth', NULL, '{"method": "email", "success": true}', '192.168.1.100', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', '2025-08-25 12:48:29.72124', 'low', 'success'),
(2, 'admin1', 'Admin Principal', 'admin@eventu.co', 'CREATE_EVENT', 'events', NULL, '{"eventId": "event123", "eventTitle": "Conferencia Tech 2024"}', '192.168.1.100', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', '2025-08-25 12:48:29.72124', 'medium', 'success')
...
BEGIN
    ...
    RAISE NOTICE '👥 Usuarios: 16 usuarios (admins, organizadores, usuarios)';
